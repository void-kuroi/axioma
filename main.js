...
// =========================================
// 3. MOTOR MATRIX RED RAIN (Roja chillona)
// =========================================
...
// =========================================
// 4. TERMINAL CON COMANDOS OCULTOS
// =========================================
...
// =========================================
// 6. NÚCLEO, EASTER EGG Y PRELOADER
// =========================================
...
document.addEventListener('keydown', (e) => {
    ...
    if (keyHistory.join('') === secretCode.join('')) { document.body.classList.toggle('god-mode'); playSound('click'); autoScrollText.innerText = '[ MODO DIOS: ACTIVADO ]'; }
});
...
window.addEventListener('load', () => { 
    ...
    if (localStorage.getItem('axioma_visted_today') === 'true') {
        ...
        iniciarSistema();
        autoScrollText.innerText = '[ RECONEXIÓN RÁPIDA ESTABLECIDA ]';
        autoScrollText.style.color = 'var(--gris-codigo)';
    } else {
...
// Seguridad
document.addEventListener('contextmenu', e => e.preventDefault());
>>>>>>> 094bfb17d5c42a0a239ca86706fd3a98b72791b9
